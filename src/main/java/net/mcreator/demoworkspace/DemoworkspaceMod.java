package net.mcreator.demoworkspace;
...
@Mod("demoworkspace")
public class DemoworkspaceMod {
	public static final Logger LOGGER = LogManager.getLogger(DemoworkspaceMod.class);
	public static final String MODID = "demoworkspace";

	public DemoworkspaceMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		DemoworkspaceModMenus.REGISTRY.register(modEventBus);
